...
* **Overtime Impact:** Employees working overtime show an attrition rate of **30.53%**, highlighting overtime as an important factor associated with employee turnover.
...
The dashboard allows users to move from the **HR Attrition Overview** to detailed **Employee Retention & Risk Analysis** using Drill-through by **Job Role and Department**.
